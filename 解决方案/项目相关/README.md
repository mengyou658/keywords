...
8. yami
9. https://github.com/lilishop/lilishop
...
3. [AJ-Report是一个完全开源，拖拽编辑的可视化设计工具。三步快速完成大屏：配置数据源---->写SQL配置数据集---->拖拽生成大屏。让管理层随时随地掌控业务动态，让每个决策都有数据支撑。 https://github.com/anji-plus/report](https://github.com/anji-plus/report)
4. [GoView 是一个Vue3搭建的低代码数据可视化开发平台，将图表或页面元素封装为基础组件，无需编写代码即可完成业务需求。 它的技术栈为：Vue3 + TypeScript4 + Vite2 + NaiveUI + ECharts5 + Axios + Pinia2 + PlopJS https://gitee.com/MTrun/go-view](https://gitee.com/MTrun/go-view)
5. superset
   [https://github.com/apache/incubator-superset](https://github.com/apache/incubator-superset)
6. Actively curated list of awesome BI tools. PRs welcome!
...
9. [一款免费的数据可视化工具，报表与大屏设计！类似于excel操作风格，在线拖拽完成报表设计！功能涵盖: 报表设计、图形报表、打印设计、大屏设计等，永久免费！https://github.com/zhangdaiscott/JimuReport](https://github.com/zhangdaiscott/JimuReport)
10. [人人可用的开源数据可视化分析工具https://github.com/dataease/dataease](https://github.com/dataease/dataease)
11. [Vue数据可视化组件库（类似阿里DataV，大屏数据展示），提供SVG的边框及装饰、图表、水位图、飞线图等组件，简单易用，长期更新(React版已发布) https://github.com/DataV-Team/DataV](https://github.com/DataV-Team/DataV)
12. [低代码 可视化 拖拽大屏 https://github.com/zzcandor/lowcode-dashboard](https://github.com/zzcandor/lowcode-dashboard)
13. [数据可视化,大屏, 支持Echarts,SQL,API,VUE,可用于Jupyter, 比pyecharts容易, 极低门槛,拿来即用,比拖拽方便,项目插件或独立平台皆可, 简单, 敏捷, 高效, 通用化, 高度可定制化,为你完全打通前后端, 图形数据联动, 筛选开发毫无压力, 数据缓存处理机制让报表快人一步 https://github.com/JohnYan2017/SmartCharts.git](https://github.com/JohnYan2017/SmartCharts.git)
14. [大屏数据可视化，轻业务开发，低代码平台，可视化编辑器，支持图层锁定、群组、对齐、排序，支持使用react、vue2和vue3自定义组件，支持拖拽可视化布局、事件交互、动态脚本、跨终端交互同步和跨屏联动交互 https://github.com/drinkjs/mojito.git](https://github.com/drinkjs/mojito.git)
15. [大数据可视化基于 koa ,mysql,mogongdb，socket.io 进行开发，整合系统配置(用户，角色，菜单权限，大屏权限)，结合数据源配置（数据库连接，api 连接，excel 导入），指标通过连接数据库，输入现成sql 语句,或者api，或者excel产生指标数据.后台起另外进程 node-schedule 达到 每 60 s (避免语句过长，卡住)根据指标库，更新指标库 content 实现 实时数据 。后台 通过配置组件，传输前端，拖拽生产大屏， 同时 通过 socket.io 根据不同 角色推送大屏 组件，以及数据结构。实现大屏整体更新。 结合 vue-cli 前端 传递信息进行实时遥控切换 https://github.com/xxn123456/big-screen-server.git](https://github.com/xxn123456/big-screen-server.git)
16. https://github.com/alibaba/DataX
17. [大屏数据可视化 Vue数据可视化组件库（类似阿里DataV，大屏数据展示），提供SVG的边框及装饰、图表、水位图、飞线图等组件，简单易用，长期更新(React版已发布) http://datav.jiaminghi.com https://github.com/DataV-Team/DataV](https://github.com/DataV-Team/DataV)
18. [一款免费的数据可视化工具，报表与大屏设计！类似于excel操作风格，在线拖拽完成报表设计！功能涵盖: 报表设计、图形报表、打印设计、大屏设计等，永久免费！https://github.com/zhangdaiscott/JimuReport](https://github.com/zhangdaiscott/JimuReport)
19. http://datav.jiaminghi.com/guide/
20. https://github.com/datavi/datav
21. https://github.com/ddiu8081/ChartFun
22. https://github.com/lizhensheng/vue-data-view
23. https://github.com/DataV-Team/DataV
24. https://github.com/yyhsong/iDataV
25. https://github.com/L-noodle/vue-big-screen
...
### network tcp udp 协议 工具库 protocol binary/bit/byte pack/encoder/encoding/serialization
...
15. java [https://github.com/tuna-cloud/engine](https://github.com/tuna-cloud/engine)
16. java [https://github.com/Keep-Tech/Taira](https://github.com/Keep-Tech/Taira)
17. java [https://github.com/zhtmf/bytesutil](https://github.com/zhtmf/bytesutil)
...
26. [这个推荐 go 支持，支持sizeof字段交互，大小端 不支持bit  https://github.com/go-restruct/restruct](https://github.com/go-restruct/restruct)
